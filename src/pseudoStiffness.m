function [pseudo_stiffness] = pseudoStiffness(GDof,numberElements,...
    elementNodes,nodeCoordinates,C,thickness)

% Data-Driven Identification
% This function computes the pseudo-stiffness matrix for T3 elements
arguments
...
% pseudo-stiffness matrix
    pseudo_stiffness(elementDof,elementDof)=...
        pseudo_stiffness(elementDof,elementDof) + A*thickness*B'*C*B; 
end
